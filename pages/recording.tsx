...
function VoiceRecordingPage() {
  ...
  return (
    <div>
      ...
      <Button.Group>
        <Button type="primary" onClick={handleRecordStart}>
          开始录音
        </Button>
        <Button onClick={handleRecordStop}>停止录音</Button>
      </Button.Group>
      ...
      {/* 进度条 */}
      {selectedFile && <Progress percent={progress} />}

      <br />
      <br />

      <Button type="primary" onClick={handleUploadButtonClick} disabled={!meetingRecord || !selectedFile}>
        上传
      </Button>
    </div>
  )
